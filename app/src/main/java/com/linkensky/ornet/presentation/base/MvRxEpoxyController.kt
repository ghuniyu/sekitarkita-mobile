 ...
 */
fun <S : MvRxState, A : MvRxViewModel<S>> Fragment.buildController(
    viewModel: A,
 ...
 */
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState> Fragment.buildController(
    viewModel1: A,
    viewModel2: C,
 ...
 * When models are built the current state of the viewmodels will be provided.
 */
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState, E : BaseMvRxViewModel<F>, F : MvRxState> Fragment.buildController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
